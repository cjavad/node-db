...
function get_obj($command, $path, $data = NULL, $override = FALSE){
...
class db {
    ...
    function push($socket, $path, $data, $override = FALSE){
...
$class = new db();
$socket = $class->init("localhost", 3434, "admin", "password");
echo $class->get($socket, "/");
?>
